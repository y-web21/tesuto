...
const required_filed = ['new_title', 'new_content'];

if (document.getElementById('btn_edit_confirm') != null) {
    document.getElementById('btn_edit_confirm').addEventListener('click', { handleEvent: insertFormMethod, method: patch });
}
...
if (document.getElementById('btn_submit_new_post') != null) {
    document.getElementById('btn_submit_new_post').addEventListener('click', { handleEvent: addRequired, target: required_filed });
}
if (document.getElementById('btn_submit_select_image') != null) {
    document.getElementById('btn_submit_select_image').addEventListener('click', { handleEvent: removeRequired, target: required_filed });
}
