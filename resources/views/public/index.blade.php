...
<div class="px-4 py-6">
    ...
    <section class="lg:grid gap-4 lg:grid-cols-3 w-full my-10">
        <div style="grid-column: 1 / 3;">
            <div class="bg-white border-2 border-gray-300 rounded-md tracking-wide shadow-lg w-full p-5 h-100per">
                @if ($top_news !== null)
        ...
        <div style="grid-column: 3 / 4;">
            <div class="bg-white border-2 border-gray-300 rounded-md tracking-wide shadow-lg p-5 my-10 lg:my-0 h-100per">
                {{ 'void' }}
            </div>
        </div>
    </section>

    <section class="grid gap-7 sm:grid-cols-1 lg:grid-cols-2 w-full my-10">
